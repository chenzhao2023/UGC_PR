"""
UGCP network based on a SwinUNETR backbone.
...
class SwinUNETR3D_UGCP(nn.Module):
    """
    SwinUNETR with UGCP refinement for binary segmentation.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        print("SwinUNETR3D_UGCP initialized. UGCP:", self.use_ugcp)
...
class UQFluxRefine(nn.Module):
    ...
    def __init__(
        ...
        self.stencil_f = DepthwiseStencil3D(feat_head_channel)
